      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <form action="<?php echo base_url()."index.php/revenue/insert_main_access";?>" method="post" enctype="multipart/form-data">
        ...
        <div class="box box-primary">
              ...
              <div class="form-group">
                  ...
                  <p class="help-block">Upload berita acara dengan format nama tanpa spasi dan berekstensi jpg atau pdf.s</p>
                </div>
              </div>
