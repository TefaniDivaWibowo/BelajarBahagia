 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <form action="<?php echo base_url()."index.php/revtarget/tambah_target_main_access";?>" method="post" enctype="multipart/form-data">
        <div class="col-sm-12">
        <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Target Revenue Maintenance Access IDR <b><?= $rev;?></b> M</h3>
            </div>
              <div class="box-body">
