      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <?php
            foreach ($datpel as $p) {
          ?>
            <form action="<?php echo base_url()."index.php/rekon/uploadfileba/".$p['nomor_speedy']."";?>" method="post" enctype="multipart/form-data">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">Nomor Pots</label>
                  <div class="col-sm-10">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">Nomor Inet</label>
                  <div class="col-sm-10">
